...
function Set-WindowState    # https://gist.github.com/lalibi/3762289efc5805f8cfcf
{
    <#
    .LINK
...
{
	if ($gps) { return }
    $Process = Start-Process "$env:APPDATA\Spotify\Spotify.exe" `
        -WorkingDirectory "$env:APPDATA\Spotify" `
